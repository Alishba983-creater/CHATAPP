...
public class ChatApp implements ActionListener {
    ...
    private static final String CLIENT_NAME = "Aslab"; 
    private JPanel buttonPanel;
    private static Socket socket;
    private static DataInputStream input;
    private static DataOutputStream output;

    public ChatApp(LinkedList<Chat> chats) throws IOException {
        if (chats == null) {
...
public void GUI() throws IOException{
        ...
        buttonPanel = new JPanel(new MigLayout("wrap 1", "[]", "[][][]"));
...
private void closeConnection() {
 ...
 JButton button = new JButton(text);
    ...
    public static void main(String[] args) throws IOException {
        ...
        ChatApp chatApp = new ChatApp(chats);
        chatApp.GUI();
    }
